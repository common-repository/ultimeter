    ...
    return this.each(function () {
      ...
      var update_title_numbers = function ($selector) {
        $selector.find(".csf-cloneable-title-number").each(function (index) {
          $(this).html(
            $(this).closest(".csf-cloneable-item").index() + 1 + "."
          );
        });
      };
        ...
        activate: function (event, ui) {
          ...
          if ($panel.length && !$panel.data("opened")) {
            ...
            $.each(inputs, function (key, $input) {
              $input
                .on("change keyup csf.keyup", function () {
                  var titles = [];
  ...
  $.fn.csf_field_map = function () {
    return this.each(function () {
      ...
      if (!$search_input.length) {
        $search_input = $(
          '[data-depend-id="' +
            $this.find(".csf--address-field").data("address-field") +
            '"]'
        );
      }
    ...
    return this.each(function () {
      var $this = $(this),
        ...
        $auto_attributes = $this.hasClass("csf-assign-field-background")
          ? $this.closest(".csf-field-background").find(".csf--auto-attributes")
          : false,
        wp_media_frame;
    ...
    return this.each(function () {
      ...
      $input.spinner({
        ...
        create: function (event, ui) {
          if (data.unit) {
            $input.after(
              '<span class="ui-button csf--unit">' + data.unit + "</span>"
            );
          }
        },
  ...
  $.fn.csf_field_wp_editor = function () {
    return this.each(function () {
      if (
        ...
        typeof window.tinyMCEPreInit.mceInit.csf_wp_editor === "undefined"
      ) {
        return;
      }
                ...
                if (Object.keys(response.errors).length) {
                  ...
                  $.each(response.errors, function (key, error_message) {
                    var $field = $('[data-depend-id="' + key + '"]'),
                      $link = $(
                        'a[href="#tab=' +
                          $field.closest(".csf-section").data("section-id") +
                          '"]'
                      ),
  ...
  $.fn.csf_shortcode = function () {
    ...
    return this.each(function () {
      ...
      $insert.on("click", function (e) {
        ...
        if (gutenberg_id) {
          var content = window.csf_gutenberg_props.attributes.hasOwnProperty(
            "shortcode"
          )
    ...
    return this.each(function () {
      ...
      if (!$this.data("inited")) {
        ...
        $this
          ...
          .csf_siblings();
        $this
          .children(".csf-field-image_select_style_packs")
          .find(".csf-siblings")
          .csf_siblings();
